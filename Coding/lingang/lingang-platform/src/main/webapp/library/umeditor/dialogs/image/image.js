...
//                img.src = window.webkitURL.createObjectURL(file);
    ...
    var Upload = {
        ...
        uploadTpl: '<div class="edui-image-upload%%">' +
            ...
            '<input style=\"filter: alpha(opacity=0);\" class="edui-image-file" type="file" hidefocus name="myFile" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp"/>' +
            '<input type="hidden" name="NoThumbnail" id="NoThumbnail" value="true" />'+
            '</form>' +
        ...
        submit: function (callback) {
            ...
            var me = this,
                input = $( '<input style="filter: alpha(opacity=0);" class="edui-image-file" type="file" hidefocus="" name="myFile" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp">'),
                input = input[0];
