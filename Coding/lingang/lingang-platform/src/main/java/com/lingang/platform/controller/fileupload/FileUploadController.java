...
public class FileUploadController {
	...
	@ResponseBody
	public JsonResult imageUpload(Integer objectId, String objectNo, Integer objectType, MultipartFile myFile,
		...
		try {
			...
			ServiceResult<SysImages> resultService = imageUpload(objectId, objectType, objectNo, originalFileName,
					contentType, imageUploadPath, in,request);
	...
	public ServiceResult<SysImages> imageUpload(Integer objectId, Integer objectType, String ObjectNo,
		...
		// 上传文件的类型
		// String imageType = uploadName.substring(uploadName.indexOf("/") + 1,
		// uploadName.length());
		// 上传文件的后缀名
