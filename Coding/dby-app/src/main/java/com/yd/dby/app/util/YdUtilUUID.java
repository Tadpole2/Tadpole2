...
public class YdUtilUUID {

	private final long mostSigBits;
	private final long leastSigBits;

	private YdUtilUUID(byte[] arg0) {
		long arg1 = 0L;
		long arg3 = 0L;
	...
	public static YdUtilUUID randomUUID() {
		SecureRandom arg = YdUtilUUID.Holder.numberGenerator;
