...
public class ChargeExample {
	...
	public Charge createCharge() {
		...
		chargeMap.put("amount", 3);// 订单总金额, 人民币单位：分（如订单总金额为 1 元，此处请填 100）
	 ...
	 * 查询 Charge
	 *
	 * 该接口根据 charge Id 查询对应的 charge 。 参考文档：https://www.pingxx.com/api#api-c-inquiry
	 *
	 * 该接口可以传递一个 expand ， 返回的 charge 中的 app 会变成 app 对象。 参考文档： https://www.pingxx.com/api#api-expanding
	 * 
	 * @param id
	 */
