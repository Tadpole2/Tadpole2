...
public class Main {
	 ...
	 */
	private final static String apiKey = "sk_live_SyHaf9nzv1805u9SKGKCeP4G";
	 ...
	 */
	private final static String appId = "app_subnvnzzHKarfXLX";
	...
	public void setPrivateKeyFilePath(String privateKeyFilePath) {
		Main.privateKeyFilePath = privateKeyFilePath;
	}
